...
class ExamSessionController extends Controller
{
    ...
    public function createEnrolle(ExamSession $exam_session)
    {
        ...
        $stundets_enrolled = ExamGroup::where('exam_id', $exam->id)->where('exam_session_id', $exam_session->id)->pluck('student_id')->all();

        $students = Student::with('classroom')->where('classroom_id', $exam->classroom_id)->whereNotIn('id', $stundets_enrolled)->get();
    ...
    public function storeEnrolle(Request $request, ExamSession $exam_session)
    {
        ...
        foreach($request->student_id as $student_id) {
            ...
            ExamGroup::create([
                'exam_id'   => $request->exam_id,
                'exam_session_id' => $request->exam_session->id,
